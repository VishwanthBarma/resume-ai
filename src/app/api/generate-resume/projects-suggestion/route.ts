...
export async function POST(req: NextRequest) {
    try {
        ...
        const prompt = `Review the following project content i.e project name, tech-stack, description content and provide concise, actionable suggestions for improvement with a focus on increasing ATS (Applicant Tracking System) compliance.
